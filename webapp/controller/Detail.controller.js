sap.ui.define([
	...
	return Controller.extend("hr_reportzhr_report.controller.Detail", {
		formatter: formatter,
		personelId: "",
		...
		_onObjectMatched: function(oEvent) {
			...
			this.personelId =  oEvent.getParameter("arguments").id;
			var detail = {
		...
		onLeaveDetail: function(oEvent) {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.navTo("leave", {
				id: 1
			});
		},
		onSalaryDetail: function(oEvent) {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
